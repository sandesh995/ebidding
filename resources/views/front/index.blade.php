...
<header class="homepage-header py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            @if(empty($search))
            <h1 class="display-4 fw-bolder text-white">Buy and Sell Anything!</h1>
            <p class="lead fw-normal mb-0">Currently {{ \App\Models\Listing::count() }} Listings and Increasing!</p>
            @endif
            <!-- Form -->
...
<section class="position-relative mb-3" style="margin-top: -400px">
    <div class="container">
        <div class="card card-body py-4">

            <h4 class="text-bold text-center my-4 pb-4">
                {{ !empty($search) ? 'Searching for: ' . $search : 'Recent Listings'}}
            </h4>
